...
<hr />
      ...
      <div className="grid cursor-pointer lg:grid-cols-4 gap-1 bg-blackk ">
        {data?.slice(0, postNum)?.map((item, key) => {
          return (
            <>
             <Link href={"/post/" + item?.attributes?.Slug}>
              <div className="h-full lg:py-20 lg:mb-[200px] hover:text-white/50" key={key}>
                <div
      ...
      <div className="w-full h-full flex justify-center mt-20 lg:mt-40">
