...
const RelatedArticlesBar = () => {
  ...
  return (
    <div className="w-full h-auto lg:px-20 px-10 font-blinker   mt-10 ">
      {/* <div className="w-full h-full pb-5 pr-5 bg-yellow "> */}
      <div className=" bg-white border-2 lg:border-4 lg:h-[400px]">
        <h1 className="ml-5 -mt-5 lg:text-2xl font-bold text-lg bg-white lg:w-[250px] text-center w-40">
          Latest Articles
        </h1>
        ...
        <div className="grid gap-1 p-1 lg:grid-cols-4 ">
          <Link href={"/post/" + ar[0]?.attributes?.Slug}>
            <div className="w-full h-40 mb-10 lg:h-[250px] hover:text-blackk/70 ">
              <div
