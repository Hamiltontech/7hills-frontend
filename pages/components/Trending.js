      ...
      <div className="flex mt-20 cursor-pointer">
        <button onClick={() => setTop(false)}>
          <h1
            className={
              top
                ? `lg:text-5xl font-extrabold uppercase text-white/30 hover:text-white ease-in-out duration-200 text-3xl`
          ...
          {ar?.map((item, key) => {
            return (
              <>
                ...
                <div
                  className=" relative flex flex-wrap py-16 lg:py-0 lg:pb-10 hover:text-white/50"
                  key={key}
                >
                  <div
                  ...
                  >
                    <div className="w-full h-full duration-200 ease-in-out group bg-blackk/40 hover:bg-blackk/70">
                      ...
                      <h1 className="flex float-left p-1 text-sm uppercase lg:hidden bg-blackk text-yellow">
                        <BsHeartFill size={20} className="m-1" /> {item?.attributes?.Reactions}
                      </h1>
                      ...
                      <div className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] hidden group-hover:block ease-in-out duration-200">
                        <button className="lg:flex duration-300 ease-in-out hover:text-white hidden">
                          ...
                          <p className="text-2xl ">{item?.attributes?.Reactions}</p>
                        </button>
                      </div>
                    </div>
                    <div className="">
                    
                        <h2 className="px-1  font-bold   ease-in-out duration-200">
                          {item?.attributes?.Title}
                        </h2>
                     
                      <p className="px-1 text-xs lg:text-sm">{item?.attributes?.Abstract}</p>
